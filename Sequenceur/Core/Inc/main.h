...
#define IN_B_Pin GPIO_PIN_0
#define IN_B_GPIO_Port GPIOC
#define IN_B_EXTI_IRQn EXTI0_IRQn
#define IN_A_Pin GPIO_PIN_3
#define IN_A_GPIO_Port GPIOC
#define IN_A_EXTI_IRQn EXTI3_IRQn
...
#define IN_C_Pin GPIO_PIN_4
#define IN_C_GPIO_Port GPIOC
#define IN_C_EXTI_IRQn EXTI4_IRQn
#define PWM_C_Pin GPIO_PIN_0
#define PWM_C_GPIO_Port GPIOB
#define L_B_Pin GPIO_PIN_1
#define L_B_GPIO_Port GPIOB
#define L_A_Pin GPIO_PIN_2
